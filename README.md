...
CTO & Technical Lead at [Bravyn](https://bravyn.com) — building AI-powered leadership coaching. Hands-on tech leader specialising in conversational AI, RAG architectures, and context engineering.
...
- **AI coaching platform** — conversational AI with RAG, context engineering, and LLM orchestration at Bravyn
...
- **[Hive](https://github.com/dznicol/hive)** — outcome-driven agent development framework that evolves

### Areas of focus

**AI/ML** — LLM application development, RAG, context engineering, conversational AI, computer vision
